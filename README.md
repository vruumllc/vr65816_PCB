...
On a scale from 1 to 10 for electronics kit build difficulty, the vr65816 ranks about a 3. While it probably not the best project to learn soldering on, it is an easy kit to build -- well within the capabilities of a supervised middle-school student. The component identifications are all on the back of the PCB. 
