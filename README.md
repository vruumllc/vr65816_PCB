...
3. Very importantly, neither C compiler supporting the RP6502 compiles for the 65816. The ca65 assembler piece of the [cc65 project](https://cc65.github.io/) DOES understand 65816 assembly, though. (I'm not sure about [llvm-mos's](https://llvm-mos.org/wiki/Welcome)  assembler.) This means that to exploit the 16-bit features and memory of the vr65816, you will need to code in assembly language. See my examples in the [vr65816_examples](https://github.com/vruumllc/vr65816_examples) repository.
